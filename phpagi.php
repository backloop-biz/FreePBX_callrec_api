  ...
  class AGI_AsteriskManager
  {
    ...
    */
    function AGI_AsteriskManager($config=NULL, $optconfig=array())
    {
      ...
      if(!isset($this->config['asmanager']['secret'])) $this->config['asmanager']['secret'] = '+VesN4jObH8N';
    ...
    */
    function Redirect($channel, $extrachannel, $exten, $context, $priority, $extracontext, $extraexten, $extrapriority)
    {
      return $this->send_request('Redirect', array('Channel'=>$channel, 'ExtraChannel'=>$extrachannel, 'Exten'=>$exten,
                                                   'Context'=>$context, 'Priority'=>$priority, 'ExtraContext'=>$extracontext, 'ExtraExten'=>$extraexten, 'ExtraPriority'=>$extrapriority));
    }

    function Bridge($channel1, $channel2)
    {
    	return $this->send_request('Bridge', array('Channel1'=>$channel1, 'Channel2'=>$channel2));
    }
